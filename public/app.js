...
var _backdoor = __webpack_require__(9);
...
var Post = {
    ...
    save: function save() {
        return _backdoor.backdoor.put('posts/' + id, Post.current).then(function (result) {
...
var _PostForm = __webpack_require__(15);

var _PostForm2 = _interopRequireDefault(_PostForm);

var _PostPage = __webpack_require__(16);

var _PostPage2 = _interopRequireDefault(_PostPage);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

_mithril2.default.route(document.body, "/posts", {
    "/posts": _PostList2.default,
    "/post/:id": _PostPage2.default,
    "/edit/:id": _PostForm2.default
});
...
var _PostCard = __webpack_require__(11);
...
exports.default = {
    oninit: _Post.Post.loadList,
    view: function view() {
        return [(0, _Header.Header)(), (0, _mithril2.default)('section.mw7 center pa3 pt6-ns pt5', [(0, _mithril2.default)('h2.avenir black-90 ph3 ph0-l', 'Latest Posts'), _Post.Post.list.map(function (post) {
            return (0, _PostCard.PostCard)(post);
        })])];
    }
};
...
var api = function api(method, path) {
    ...
    var req = _mithril2.default.request({
        method: method,
        url: baseUrl + path
    });
    if (payload) {
...
var menus = ['programming', 'media', 'contact'];

_store2.default.activeMenu = 0;

var Header = exports.Header = function Header() {
    return (0, _mithril2.default)('div', (0, _mithril2.default)('header.bg-black bb bw1 b--silver shadow-1 fixed w-100 ph3 pv3 pv4-ns ph4-m ph5-l', { style: "z-index: 9999" }, (0, _mithril2.default)('nav.f6 f6w tracked', [(0, _Logo2.default)(), menus.map(function (value, index) {
        return (0, _Menu2.default)({ id: index + 1, caption: value });
    })])));
};
...
var Logo = function Logo() {
    var accent = _store2.default.activeMenu == 0 ? 'gold' : 'gold';
    return (0, _mithril2.default)('a.f4 avenir ' + accent + ' link dim dib mr3 ttu pointer', {
...
var Menu = function Menu(_ref) {
    ...
    var accent = id === _store2.default.activeMenu ? 'white' : '';
    return (0, _mithril2.default)('a.link avenir ' + accent + ' silver hover-near-white dib mr3 ttu pointer', {
        onclick: function onclick() {
            _store2.default.activeMenu = id;
        }
    }, caption);
};
...
module.exports = {
    oninit: function oninit(vnode) {
        _Post.Post.load(vnode.attrs.id);
    },
    view: function view() {
        ...
        }, [(0, _mithril2.default)("label.label", "Title"), (0, _mithril2.default)("input.input[type=text][placeholder=title]", {
            oninput: _mithril2.default.withAttr("value", function (value) {
                _Post.Post.current.title = value;
            }),
            value: _Post.Post.current.title
        }), (0, _mithril2.default)("label.label", "Body"), (0, _mithril2.default)("textarea.input[placeholder=body]", {
            oninput: _mithril2.default.withAttr("value", function (value) {
                _Post.Post.current.body = value;
            }),
            value: _Post.Post.current.body
        }), (0, _mithril2.default)("label.label", "Tag"), (0, _mithril2.default)("input.input[placeholder=tag]", {
            oninput: _mithril2.default.withAttr("value", function (value) {
                ...
                tags = arrTags;
                _Post.Post.current.tags = tags;
            }),
            //magic here, we can just display all tags array element straight as the value of input
            value: _Post.Post.current.tags
